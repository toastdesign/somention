...
function toastframe_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'toastframe' ),
	) );
 ...
 */
function toastframe_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'toastframe_content_width', 640 );
}
add_action( 'after_setup_theme', 'toastframe_content_width', 0 );
...
function toastframe_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'toastframe' ),
		'id'            => 'sidebar-1',
		'description'   => '',
